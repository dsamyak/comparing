...
const REFLECT_QUESTIONS = [
  { q: "Which place value is the most important when comparing two 4-digit numbers?", options: [
    { text: "Thousands", correct: true, emoji: "⭐" },
    { text: "Ones", correct: false, emoji: "❌" },
    { text: "Hundreds", correct: false, emoji: "❓" },
  ]},
  { q: "If two numbers have the same thousands digit, what do you look at next?", options: [
    { text: "Hundreds digit", correct: true, emoji: "✅" },
    { text: "Tens digit", correct: false, emoji: "❌" },
    { text: "They are equal", correct: false, emoji: "❓" },
  ]},
  { q: "What does 'ascending order' mean?", options: [
    { text: "Least to greatest", correct: true, emoji: "📈" },
    { text: "Greatest to least", correct: false, emoji: "📉" },
    { text: "Random order", correct: false, emoji: "❓" },
  ]},
];

const CONFIDENCE_LEVELS = [
  { emoji: '😊', label: "I'm great at comparing numbers!", color: '#4caf50' },
  { emoji: '🙂', label: 'I can order most numbers!', color: '#ff9800' },
...
export default function ReflectPhase({ stats, onRestart, onGoHome, audioEnabled }) {
  ...
  if (step === 1) {
    return (
      <div className="reflect-phase">
        <div className="reflect-card">
          <h3 className="reflect-card-title">How do you feel about comparing numbers?</h3>
      ...
      <div className="certificate-card">
        ...
        <div className="mascot-container" style={{ marginTop: 16 }}>
          ...
          <div className="speech-bubble">
            {pct >= 80 ? 'Incredible! You are a Space Race Champion! 🏆' : pct >= 50 ? 'Great effort! Keep practicing your navigation! 💪' : 'Good start! Try again to improve! 📚'}
          </div>
        </div>
